...
if [ ! -f /files/var/supervisord ]; then
  ...
  wget -q -O /files/var/supervisord \
    https://github.com/ochinchina/supervisord/releases/download/v0.6.3/supervisord_0.6.3_linux_amd64
